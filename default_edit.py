...
class LSTMTaggerModel(nn.Module):
    ...
    def forward(self, sentence_in, sentence):
        ...
        #print("The type of embeds is")
        #print(type(embeds))
        #print("The type of sentence is")
        #print(type(sentence_in))
        #print("The shape of sentence is")
        #print(sentence_in.shape)
        #print("The shape of embeds is")
        #print(embeds.shape)
        #count = 1
        stack_ = []
        for word in sentence:
            ...
            #if count == 1:
                 #stack_tensor = character_level
            #else:
                 #print("shape of stack tensor is")
                 #print(stack_tensor.shape)
                 #print("shape of character tensor is")
                 #print(character_level.shape)   
                 #stack_tensor = torch.stack([stack_tensor, character_level], dim = 0)
                   
            #count = count + 1
        stack_tensor = torch.stack(stack_, dim = 0)    
        #print("the embeds shape is")
        #print (embeds.shape)
        #print("the stack_tensor shape is")
        #print(stack_tensor.shape)
